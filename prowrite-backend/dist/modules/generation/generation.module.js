...
exports.GenerationModule = GenerationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [gemini_service_1.GeminiService, generation_service_1.GenerationService],
        exports: [gemini_service_1.GeminiService, generation_service_1.GenerationService],
    })
], GenerationModule);
